...
public class MapsDriverActivity extends FragmentActivity implements OnMapReadyCallback {

    private GoogleMap mMap;
    private TextView date, time, fare;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date = findViewById(R.id.dateMap2);
        time = findViewById(R.id.timeMap2);
        fare = findViewById(R.id.fareQ);
